    ...
    <>
      <nav className="fixed top-4 left-1/2 -translate-x-1/2 z-50 w-full max-w-md px-4">
        <div className="relative">
          {/* Main nav bar */}
          <div className="bg-white/10 backdrop-blur-md rounded-full border border-white/20 py-2">
      ...
      {/* Mobile navigation menu */}
      <div className={`md:hidden fixed top-16 left-4 right-4 bg-white/10 backdrop-blur-md rounded-2xl border border-white/20 transition-all duration-500 ease-in-out overflow-hidden z-40 ${
